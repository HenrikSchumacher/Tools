...
>
OutString & PutVector( A && a, C && to_chars, Int_0 d_0, bool check_sizeQ = true )
{
    return PutArray(
...
OutString & PutVector( A && a, Int_0 d_0, bool check_sizeQ = true )
{
    return PutVector<Fmt>(std::forward<A>(a), ToChars<Result_T<A>>(), d_0, check_sizeQ );
}
...
{
    return PutVector<Fmt>( [a]( const Int_0 i_0 ) { return a[i_0]; }, std::forward<C>(to_chars), d_0, check_sizeQ );
}
...
{
    return PutVector<Fmt>( [a]( const Int_0 i_0 ) { return a[i_0]; }, ToChars<T>(), d_0, check_sizeQ );
}
...
static OutString FromVector( A && a, C && to_chars, Int_0 d_0 )
{
    ...
    out.PutVector<Fmt>( std::forward<A>(a), std::forward<C>(to_chars), d_0, false );
