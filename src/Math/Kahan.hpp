...
namespace Tools
{
    ...
    force_inline std::pair<Real,Real> Det2D_Kahan_DiffPair(
...
//
    ...
    template<typename Real>
    force_inline std::pair<Real,Real> Dot2D_Kahan_DiffPair(
    ...
    force_inline Out_T DetSign2D_Kahan(
        const Real a, const Real b,
        const Real c, const Real d
    )
    {
    ...
    template<typename Out_T = int, typename Real>
    force_inline Out_T DotSign2D_Kahan(
        const Real u_0, const Real u_1,
    ...
    template<typename Out_T = int, typename Real>
    force_inline Real DotSign2D_Kahan( cptr<Real> u, cptr<Real> v )
    {
